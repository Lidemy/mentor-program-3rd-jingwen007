...
<body>
<div><h2 style="text-align:center;">登入系統</h2></div>
<h4> ** 本站為練習用網站，因教學用途刻意忽略資安的實作，註冊時請勿使用任何真實的帳號或密碼  ** </h4>
    <form class="form" action="handle_login2.php" method='POST'>
        <div style="text-align:center;    padding-top: 10px;">請輸入帳號及密碼</div>
